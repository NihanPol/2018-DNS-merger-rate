...
import dosurvey_1913 as dosurvey, populate
...
for xx, npop in enumerate(pops):
    ...
    for ii in range(runs_of_pop):
        ...
        pop = populate.generate(npop, pDistPars = [log_p_1913, 0.0], duty_percent = 16.9, orbits = False, nostdout = True, zscale = 0.33, siDistPars=[-1.4, 1.0], lumDistPars = lum_params)
    ...
    filepath = "./pop_result_z330_1913_varlum/npop={:5d}.npy".format(npop)
