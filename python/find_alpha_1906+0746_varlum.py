...
import dosurvey_1906 as dosurvey, populate
...
log_p_1756_2251 = np.log10(28.462)
log_p_1906_0746 = np.log10(144.073)
...
#model_name = './1906_0746_z330.model'
model_name = './1906_0746_z330_varlum.model'
...
for xx, npop in enumerate(pops):
    ...
    for ii in range(runs_of_pop):
        ...
        pop = populate.generate(npop, pDistPars = [log_p_1906_0746, 0.0], duty_percent = 1., orbits = False, nostdout = True, zscale = 0.33, siDistPars=[-1.4, 1.0], lumDistPars = lum_params)
    ...
    filepath = "./pop_result_z330_1906_0746_varlum/npop={:5d}.npy".format(npop)
