...
import dosurvey_1757 as dosurvey, populate
...
model_name = './1757_z330_varlum.model'
...
for xx, npop in enumerate(pops):
    ...
    for ii in range(runs_of_pop):
        ...
        pop = populate.generate(npop, pDistPars = [log_p_1757, 0.0], duty_percent = 6., orbits = False, nostdout = True, zscale = 0.33, siDistPars=[-1.4, 1.0], lumDistPars = lum_params)
    ...
    filepath = "./pop_result_z330_1757_varlum/npop={:5d}.npy".format(npop)
