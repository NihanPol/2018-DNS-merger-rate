...
for xx, npop in enumerate(pops):
    ...
    for ii in range(runs_of_pop):
        ...
        pop = populate.generate(npop, pDistPars = [log_p_0737B, 0.0], duty_percent = 1.3, orbits = False, nostdout = True, zscale = 0.33, siDistPars=[-1.4, 1.0])
    ...
    filepath = "./pop_result_z330_0737B/npop={:5d}.npy".format(npop)
